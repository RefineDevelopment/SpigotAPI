...
public class CarbonSpigotListener implements IListener, Listener {
    ...
    public void onAdd(PotionEffectAddEvent event) {
        xyz.refinedev.spigot.event.impl.PotionEffectAddEvent.EffectAddReason reason = xyz.refinedev.spigot.event.impl.PotionEffectAddEvent.EffectAddReason.valueOf(event.getReason().name());
