...
public class CarbonSpigotListener implements IListener, Listener {
    ...
    public void onAdd(PotionEffectAddEvent event) {
        xyz.refinedev.api.spigot.event.impl.PotionEffectAddEvent.EffectAddReason reason = xyz.refinedev.api.spigot.event.impl.PotionEffectAddEvent.EffectAddReason.valueOf(event.getReason().name());
    ...
    public void onExtend(PotionEffectExtendEvent event) {
        xyz.refinedev.api.spigot.event.impl.PotionEffectAddEvent.EffectAddReason reason = xyz.refinedev.api.spigot.event.impl.PotionEffectAddEvent.EffectAddReason.valueOf(event.getReason().name());
        xyz.refinedev.api.spigot.event.impl.PotionEffectExtendEvent custom = new xyz.refinedev.api.spigot.event.impl.PotionEffectExtendEvent(event.getEntity(), event.getEffect(), reason, event.getOldEffect());
        Bukkit.getPluginManager().callEvent(custom);
    }
